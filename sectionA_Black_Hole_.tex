...
\citet{Khabibullin_2014} have explored a similar question.  They looked for sources which had faded by a factor $\gtrsim 10$/decade to search for TDEs of stars by SMBHs, and conclude based upon a handful of candidate events, that the rate is of order $10^{-5}/yr$ per galaxy.  Our calculations indicate {\bf ???  that it is comparably... CHECK}  probable to disrupt a giant star by a {\em stellar} BH ??.   

Unlike a TDE by an AGN, the X-ray emission for the stellar-mass event is likely to persist for an extended timeframe
